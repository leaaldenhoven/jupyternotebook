...
sfreq=sample_freq
#ICA SPECS
ICA_NAME_SPECS = '_SELECT_0.1-8Hz_R'+str(sample_freq)+'-ica.fif'
...
raw = mne.io.read_raw_brainvision(join(fullpath, hdrfile), preload=True, misc=('Stim',), eog=('64','65'), montage='easycap-M1')
...
print("Filtering data between 0.1 and 8 Hz")
low_pass = lp #y
high_pass = hp #x
